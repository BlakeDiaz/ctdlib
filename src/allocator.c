...
ctd_default_allocator ctd_default_allocator_instance = {.allocator = {.context = NULL, .allocate = ctd_malloc, .reallocate = ctd_realloc, .free = ctd_free}};

ctd_default_allocator ctd_default_allocator_create()
{
    ctd_allocator allocator = {.allocate = ctd_malloc, .reallocate = ctd_realloc, .free = ctd_free, .context = NULL};
